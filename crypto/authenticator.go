...
const (
	...
	AccountAuthenticatorMultiAuthKey AccountAuthenticatorType = 4 // AccountAuthenticatorMultiAuthKey is the authenticator type for multi-authkey accounts
)
...
func (ea *AccountAuthenticator) UnmarshalBCS(des *bcs.Deserializer) {
	...
	case AccountAuthenticatorMultiAuthKey:
		ea.Auth = &MultiAuthKeyAuthenticator{}
	default:
