...
import "github.com/endless-labs/endless-go-sdk/bcs"
...
// its own as a [PublicKey] for authentication on Endless.  An example is [Secp256k1PublicKey].  All [PublicKey]s are also
// VerifyingKeys.
