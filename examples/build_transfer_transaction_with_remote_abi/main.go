// build_transfer_transaction_with_remote_abi is an example of how to build a transfer transaction with remote abi in the simplest possible way.
package main
...
func example(networkConfig endless.NetworkConfig) {
	...
	entryFunction2, err := client.EntryFunctionWithArgs(
		endless.AccountOne,
		"endless_account",
		"transfer_coins",
		[]any{endless.EndlessCoinTypeTag},
		[]any{recipient.Address, TransferAmount, "ENDLESSsssssssssssssssssssssssssssssssssssss"},
	)
	if err != nil {
		panic("Failed to call EntryFunctionWithArgs:" + err.Error())
