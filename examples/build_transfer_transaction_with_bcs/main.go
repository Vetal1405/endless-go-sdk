// build_transfer_transaction_with_bcs is an example of how to build a transfer transaction with sdk in the simplest possible way.
package main
...
func example(networkConfig endless.NetworkConfig) {
	...
	pendingTransaction, err = client.BuildSignAndSubmitTransaction(sender, transactionPayload)
	if err != nil {
		panic("Failed to sign transaction:" + err.Error())
	}
