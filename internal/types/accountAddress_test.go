...
func TestStringOutput(t *testing.T) {
	...
	expected := []string{
		...
		"0x1",
		"0xf",
		"2E4PegLDJXrfXFQP8N1ETpg9XbkrQNV4QcAksY4D9rG6", //base58
		"9bsJkis19wEzBUnzHk68zkVPSiX7ArZ4jEYpR6Hcyga",  //base58
		"1o41mGhDUwpAoEqyHDCM9G2sRayhGejtzcmp2UJBNMt",  //base58
		"14bq7G43mEBQUqndFMB7nJoWV75p6KWQtovHBE3jQVC",  //base58
		"114eZ6LHTFYWTJsBQrqgW4XtuZkzKxa83zWpSTMrufU",  //base58
	}
	for i := 0; i < len(inputs); i++ {
		addr := AccountAddress(inputs[i])
