...
func TestStructTag(t *testing.T) {
	...
	assert.Equal(t, "0x1::coin::CoinStore<0x1::endless_coin::EndlessCoin>", st.String())
	...
	assert.Equal(t, "0x1::coin::CoinStore<0x1::endless_coin::EndlessCoin,0x3::other::thing>", st.String())
}
